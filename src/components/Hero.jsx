...
import SocialIcons from './SocialIcons'; // Updated import
...
const Hero = ({ language = "pt" }) => {
  ...
  return (
    <section className="relative h-screen w-full mt-16 overflow-hidden flex items-center justify-center bg-background text-foreground px-4">
      ...
      <div className="container mx-auto px-4 sm:px-6 text-center relative z-10 flex flex-col items-center justify-center h-full">
        ...
        >
          ...
          <motion.div
            ...
            variants={itemVariants}
          >
            <SocialIcons language={language} /> {/* Updated to use the new self-contained component */}
          </motion.div>
        </motion.div>
